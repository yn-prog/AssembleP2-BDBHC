                    ...
                    <form id="patientForm" action="{{ route('health.records.store') }}" method="POST">
                        ...
                        <div class="record-section">
                            ...
                            <select name="visit_purpose[]" multiple class="form-select" id="visit_purpose_add">
                                @if (in_array($userRole, ['physician', 'nurse']))
                                    @foreach ($allPurposes as $purpose)
                            ...
                            <div class="form-group">
                                ...
                                <select name="visit_purpose[]" multiple class="form-select" id="visit_purpose_edit">
                                    @if (in_array($userRole, ['physician', 'nurse']))
                                        @foreach ($allPurposes as $purpose)
                                            <option value="{{ $purpose }}"
                                                {{ (isset($record) && in_array($purpose, json_decode($record->visit_purpose ?? '[]', true))) ? 'selected' : '' }}>
                                                {{ $purpose }}
                                            </option>
                                        @endforeach
                                    @elseif ($userRole == 'dentist')
                                    ...
                                    @elseif ($userRole == 'midwife')
                                        ...
                                        @endforeach
                                    @endif
                                    <option value="Others" {{ (isset($record) && in_array('Others', json_decode($record->visit_purpose ?? '[]', true))) ? 'selected' : '' }}>Others</option>
                                </select>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    try {
        const record = {!! json_encode($record ?? null) !!};
